...
void test_add(decimal decimal1, decimal decimal2, decimal check) {
  decimal result = {{0}};
  int code = add(decimal1, decimal2, &result);

  ck_assert_int_eq(is_equal(result, check), 1);
  ck_assert_int_eq(code, 0);
}

void test_add_fail(decimal decimal1, decimal decimal2, int check) {
  decimal result = {{0}};
  int code = add(decimal1, decimal2, &result);
...
START_TEST(test_add8) {
  ...
  decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
  // -7922816251426433759354395033
  decimal decimal2 = {{0xFFFFFFFD, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}};
  // 2
  decimal check = {{0x2, 0x0, 0x0, 0x0}};
...
Suite *add_suite_create(void) {
  ...
  s = suite_create("Add");
  tc_core = tcase_create("Core of add");
  ...
  tcase_add_test(tc_core, add_45);
  tcase_add_test(tc_core, add_50);
  tcase_add_test(tc_core, add_51);
  tcase_add_test(tc_core, add_52);
