...
START_TEST(dec_to_int_6) {
  ...
  decimal dec = {{4896775, 0, 0, 0}};

  from_decimal_to_int(dec, &num_int);
...
START_TEST(dec_to_int_9) {
  int num_int = 0;
  decimal dec = {{0, 12, 0, 0}};

  int exepted_result = 1, real_result = 0;

  real_result = from_decimal_to_int(dec, &num_int);
...
START_TEST(dec_to_int_11) {
  int num_int = 0;
  decimal dec = {{UINT32_MAX, 0, 0, 0b10000000000000000000000000000000}};
...
START_TEST(dec_to_int_12) {
  int num_int = 0;
  decimal dec = {{12, 0, 0, 0b10000000000000000000000000000000}};
