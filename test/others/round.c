...
START_TEST(round_1) {
  ...
  int check = decimal_round(src, &result);
  int check_origin = 0;
  // origin = 5;
...
Suite *round_suite_create(void) {
  ...
  tcase_add_test(tcase_core, round_11);
  tcase_add_test(tcase_core, round_12);
  tcase_add_test(tcase_core, round_13);
  tcase_add_test(tcase_core, round_14);
  tcase_add_test(tcase_core, round_15);
  tcase_add_test(tcase_core, round_16);
  tcase_add_test(tcase_core, round_17);
  tcase_add_test(tcase_core, round_18);
  tcase_add_test(tcase_core, round_19);
  tcase_add_test(tcase_core, round_20);
  tcase_add_test(tcase_core, round_21);
  tcase_add_test(tcase_core, round_22);
  tcase_add_test(tcase_core, round_23);
  tcase_add_test(tcase_core, round_24);
