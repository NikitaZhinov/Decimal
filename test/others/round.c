...
END_TEST
Suite *round_suite_create(void) {
  Suite *suite = suite_create("round");
  TCase *tcase_core = tcase_create("Core of round");
  ...
  tcase_add_test(tcase_core, s21_round_10);
  tcase_add_test(tcase_core, s21_round_11);
  tcase_add_test(tcase_core, s21_round_12);
  tcase_add_test(tcase_core, s21_round_13);
  tcase_add_test(tcase_core, s21_round_14);
  tcase_add_test(tcase_core, s21_round_15);
  tcase_add_test(tcase_core, s21_round_16);
  tcase_add_test(tcase_core, s21_round_17);
  tcase_add_test(tcase_core, s21_round_18);
  tcase_add_test(tcase_core, s21_round_19);
  tcase_add_test(tcase_core, s21_round_20);
  tcase_add_test(tcase_core, s21_round_21);
  tcase_add_test(tcase_core, s21_round_22);
  tcase_add_test(tcase_core, s21_round_23);
  tcase_add_test(tcase_core, s21_round_24);
