...
START_TEST(truncate_1) {
  ...
  decimal ex_result = {{4123168604, 12, 0, 0}};
  decimal res = {{0}};
...
START_TEST(truncate_2) {
  decimal num = {{0, 1, 0, 0b00000000000000110000000000000000}};
  decimal ex_result = {{4294967, 0, 0, 0}};
  decimal res = {{0}};
...
START_TEST(truncate_3) {
  decimal num = {{100, 0, 0, 0b00000000000000110000000000000000}};
  decimal ex_result = {{1, 0, 0, 0}};
  decimal res = {{0}};
...
Suite *truncate_suite_create(void) {
  Suite *suite = suite_create("Truncate");
  TCase *tcase_core = tcase_create("Core of truncate");
  ...
  tcase_add_test(tcase_core, truncate_11);
  tcase_add_test(tcase_core, truncate_12);
  tcase_add_test(tcase_core, truncate_13);
  tcase_add_test(tcase_core, truncate_14);
  tcase_add_test(tcase_core, truncate_15);
  tcase_add_test(tcase_core, truncate_16);
  tcase_add_test(tcase_core, truncate_17);
  tcase_add_test(tcase_core, truncate_18);
  tcase_add_test(tcase_core, truncate_19);
  tcase_add_test(tcase_core, truncate_20);
  tcase_add_test(tcase_core, truncate_21);
  tcase_add_test(tcase_core, truncate_22);
  tcase_add_test(tcase_core, truncate_23);
  tcase_add_test(tcase_core, truncate_24);
  tcase_add_test(tcase_core, truncate_25);
  tcase_add_test(tcase_core, truncate_26);
  tcase_add_test(tcase_core, truncate_27);
  tcase_add_test(tcase_core, truncate_28);
  tcase_add_test(tcase_core, truncate_29);
  tcase_add_test(tcase_core, truncate_30);
  tcase_add_test(tcase_core, truncate_31);
  tcase_add_test(tcase_core, truncate_32);
  tcase_add_test(tcase_core, truncate_33);
  tcase_add_test(tcase_core, truncate_34);
  tcase_add_test(tcase_core, truncate_35);
  tcase_add_test(tcase_core, truncate_36);
  tcase_add_test(tcase_core, truncate_37);
  tcase_add_test(tcase_core, truncate_38);
  tcase_add_test(tcase_core, truncate_39);
  tcase_add_test(tcase_core, truncate_40);
  tcase_add_test(tcase_core, truncate_41);
  tcase_add_test(tcase_core, truncate_42);
