...
START_TEST(is_greater_1) {
  ...
  int exepted_result = 0, real_result = s21_is_greater(num1, num2);
...
START_TEST(is_greater_2) {
  ...
  int exepted_result = 1, real_result = s21_is_greater(num1, num2);
...
Suite *is_greater_suite_create(void) {
  Suite *suite = suite_create("Is greater");
  TCase *tcase_core = tcase_create("Core of is greater");
